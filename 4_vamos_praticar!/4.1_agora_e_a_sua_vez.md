...
Sabendo que existem 109 países cadastrados na tabela *country* e 600 cidades cadastradas na tabela *city*, faça os exercícios 4 e 5 abaixo:

4. 🚀 Construa uma *query* que retorne o nome da cidade (na tabela *city*) e o país o qual ela pertence (na tabela *country*) com o ``LEFT JOIN``.

5. 🚀 Refaça o exercício 1 trocando o ``LEFT JOIN`` por ``RIGHT JOIN``.
